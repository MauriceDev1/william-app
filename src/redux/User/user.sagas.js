...
import { auth, handelUserProfile, getCurrentUser ,GoogleProvider } from '../../firebase/utils'
import userTypes from './user.types' 
import { signInSuccess, signOutUserSuccess, userError, resetPasswordSuccess } from './user.actions'
import { handelResetPasswordAPI } from '../User/user.helpers'
...
export function* resetPassword({ payload: { email }}) {
    try {
        yield call(handelResetPasswordAPI, email);
        yield put (
