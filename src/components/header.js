            ...
            <div className="relative bg-white">
                <div className="max-w-7xl mx-auto px-4 sm:px-6">
                    ...
                    <div className="hidden md:flex items-center justify-end md:flex-1 lg:w-0">
                        ...
                        <a href="#" className="ml-8 whitespace-nowrap inline-flex items-center justify-center px-4 py-2 border border-transparent rounded-sm shadow-sm text-base font-medium text-white bg-black hover:bg-gray-500">
                        Sign up
                        </a>
                    </div>
                    </div>
